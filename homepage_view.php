...
<section id="banner" class="parallex-bg section-padding">
	<div class="container">
    	<div class="intro_text white-text div_zindex">
    		<h1>Bienvenue sur el-Dalile </h1>
	        <h5>Tous les professionnels de votre ville :</h5>
            <div class="search_form">
            	<form action="<?=base_url('listing_map/index') ?>" method="get">
                	<div class="form-group ">
					
				     <form class="cd-search" method="get" action="<?=base_url('/pages/detail/'); ?>">
                          <div class="inner-form">
                            <div class="row">
                            <div class="input-field second">
                             <input type="search" id="title" name="title" placeholder="Recherche" />
