...
class Category_ser extends Admin_Controller 
{
	...
	*/
	public function index()
	{
		...
		$this->render('admin/services/category');	
	}	
	...
	*/
	...
	{
		if($id) {
			$data = $this->Model_ser_category->getCategoryData($id);
	...
	*/
	public function fetchCategoryData()
	{
		...
		$data = $this->Model_ser_category->getCategoryData();
	...
	public function create()
	{
      ...
      $response = array();
        ...
        if ($this->form_validation->run() == TRUE) {
        	...
        	$create = $this->Model_ser_category->create_cat($data);
        	if($create == true) {
     ...
     $response = array();
		...
		if($id) {
	        ...
	        if ($this->form_validation->run() == TRUE) {
	        	...
	        	$update = $this->Model_ser_category->update_cat($data, $id);
	        	if($update == true) {
	        		$response['success'] = true;
	...
	*/
	public function remove()
	{
		...
		$response = array();
		if($category_id) {
			$delete = $this->Model_ser_category->remove($category_id);
			if($delete == true) {
				$response['success'] = true;
