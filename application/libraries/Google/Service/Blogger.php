...
class Google_Service_Blogger_Pages_Resource extends Google_Service_Resource
{
  ...
  /**
   * Retrieves the pages for a blog, optionnelly including non-LIVE statuses.
   * (pages.listPages)
   *
...
class Google_Service_Blogger_Posts_Resource extends Google_Service_Resource
{
  ...
  /**
   * Publishes a draft post, optionnelly at the specific time of the given
   ...
   * @param array $optParams optionnel parameters.
   *
   * @opt_param string publishDate optionnel date and time to schedule the
