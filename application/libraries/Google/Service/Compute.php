...
class Google_Service_Compute_Addresses_Resource extends Google_Service_Resource
{
   ...
   *
   * @opt_param string filter optionnel. Filter expression for filtering listed
   * resources.
   * @opt_param string pageToken optionnel. Tag returned by a previous list request
   * truncated by maxResults. Used to continue a previous list request.
   * @opt_param string maxResults optionnel. Maximum count of results to be
...
class Google_Service_Compute_Disks_Resource extends Google_Service_Resource
{
   ...
   * @param array $optParams optionnel parameters.
   *
   * @opt_param string sourceImage optionnel. Source image to restore onto a disk.
   * @return Google_Service_Compute_Operation
   */
