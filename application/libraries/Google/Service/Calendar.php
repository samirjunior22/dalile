...
class Google_Service_Calendar_Acl_Resource extends Google_Service_Resource
{
   ...
   * optionnel. The default is to return all entries.
   ...
   * always be included if syncToken is provided. optionnel. The default is False.
...
class Google_Service_Calendar_CalendarList_Resource extends Google_Service_Resource
{
   ...
   * automatically. optionnel. The default is False.
   * @return Google_Service_Calendar_CalendarListEntry
   */
   ...
   * synchronization. optionnel. The default is to return all entries.
   * @opt_param bool showDeleted Whether to include deleted calendar list entries
   * in the result. optionnel. The default is False.
   * @opt_param string minAccessRole The minimum access role for the user in the
   * returned entires. optionnel. The default is no restriction.
   * @opt_param int maxResults Maximum number of entries returned on one result
   * page. By default the value is 100 entries. The page size can never be larger
   * than 250 entries. optionnel.
   * @opt_param string pageToken Token specifying which result page to return.
   * optionnel.
   * @opt_param bool showHidden Whether to show hidden entries. optionnel. The
   * default is False.
...
class Google_Service_Calendar_Events_Resource extends Google_Service_Resource
{
   ...
   * deletion of the event. optionnel. The default is False.
   */
   ...
   * @param array $optParams optionnel parameters.
   *
   * @opt_param string timeZone Time zone used in the response. optionnel. The
   ...
   * optionnel. The default is False.
   ...
   * participant is returned. optionnel.
   ...
   *
   * @opt_param bool sendNotifications Whether to send notifications about the
   * creation of the new event. optionnel. The default is False.
   * @opt_param int maxAttendees The maximum number of attendees to include in the
   * response. If there are more than the specified number of attendees, only the
   * participant is returned. optionnel.
   * @return Google_Service_Calendar_Event
   ...
   * will still be included if singleEvents is False. optionnel. The default is
   * False.
   * @opt_param string timeMax Upper bound (exclusive) for an event's start time
   * to filter by. optionnel. The default is not to filter by start time.
   * @opt_param bool alwaysIncludeEmail Whether to always include a value in the
   * email field for the organizer, creator and attendees, even if no real email
   * is available (i.e. a generated, non-working value will be provided). The use
   * of this option is discouraged and should only be used by clients which cannot
   ...
   * optionnel. The default is an unspecified, stable order.
   ...
   * syncToken. Learn more about incremental synchronization. optionnel. The
   ...
   * underlying recurring events) are returned. optionnel. The default is False.
   * @opt_param string iCalUID Specifies event ID in the iCalendar format to be
   * included in the response. optionnel.
   ...
   * since this time will always be included regardless of showDeleted. optionnel.
   ...
   * events, but not the underlying recurring events themselves. optionnel. The
   * default is False.
   * @opt_param string timeMax Upper bound (exclusive) for an event's start time
   * to filter by. optionnel. The default is not to filter by start time.
   * @opt_param bool alwaysIncludeEmail Whether to always include a value in the
   ...
   * terms in any field, except for extended properties. optionnel.
   * @opt_param string pageToken Token specifying which result page to return.
   * optionnel.
   * @opt_param string timeMin Lower bound (inclusive) for an event's end time to
   * filter by. optionnel. The default is not to filter by end time.
   ...
   *
   * @opt_param bool sendNotifications Whether to send notifications about the
   * change of the event's organizer. optionnel. The default is False.
   * @return Google_Service_Calendar_Event
   */
   ...
   *
   * @opt_param bool sendNotifications Whether to send notifications about the
   * event update (e.g. attendee's responses, title changes, etc.). optionnel. The
   * default is False.
   * @opt_param bool alwaysIncludeEmail Whether to always include a value in the
   * email field for the organizer, creator and attendees, even if no real email
   * is available (i.e. a generated, non-working value will be provided). The use
   ...
   *
   * @opt_param bool sendNotifications Whether to send notifications about the
   * creation of the event. optionnel. The default is False.
   * @return Google_Service_Calendar_Event
   */
