...
class Google_Service_Reseller_Customers_Resource extends Google_Service_Resource
{
   ...
   * https://www.google.com/a/cpanel//TransferToken. optionnel.
   * @return Google_Service_Reseller_Customer
   */
...
class Google_Service_Reseller_Subscriptions_Resource extends Google_Service_Resource
{
   ...
   * domain/TransferToken. optionnel.
   * @return Google_Service_Reseller_Subscription
   */
  ...
  /**
   * Lists subscriptions of a reseller, optionnelly filtered by a customer name
   ...
   * https://www.google.com/a/cpanel/customer-domain/TransferToken.optionnel.
   ...
   * which the subscriptions should be filtered. optionnel
