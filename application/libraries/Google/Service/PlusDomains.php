...
class Google_Service_PlusDomains_Circles_Resource extends Google_Service_Resource
{
   ...
   * @param array $optParams optionnel parameters.
   *
   * @opt_param string userId IDs of the people to add to the circle. optionnel,
   * can be repeated.
   * @opt_param string email Email of the people to add to the circle. optionnel,
   * can be repeated.
