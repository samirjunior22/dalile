...
class Google_Service_AdSense_AccountsReports_Resource extends Google_Service_Resource
{
   ...
   * resulting report on, optionnelly prefixed with "+" to sort ascending or "-" to
   * sort descending. If no prefix is specified, the column is sorted ascending.
   * @opt_param string locale optionnel locale to use for translating report output
   ...
   * @opt_param string currency optionnel currency to use when reporting on
