...
class  Googlemaps {
	...
	var $language					= 'en';						// The map will by default load in the language of the browser. This can be overriden however here. For a full list of codes see https://spreadsheets.google.com/pub?key=p9pdwsai2hDMsLkXsoM05KQ&gid=1
	...
	function _Googlemaps($config = array())
	{
		if (count($config) > 0)
		{
	...
	function create_map()
	{
		...
		if ($this->maps_loaded == 0)
		{
			...
			{
				 $apiLocation  = 'https://maps-api-ssl.google.com/maps/api/js?';
			}
