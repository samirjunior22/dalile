...
class Admin_Controller extends MY_Controller
{
	...
	protected function render_admine($the_view = NULL, $template = 'admine_master')
	{
		parent::render($the_view, $template);
	}
	protected function render_customer($the_view = NULL, $template = 'customer_master')
	{
		parent::render($the_view, $template);
	}
}
...
class Public_Controller extends MY_Controller
{
   ...
   function is_not_login(){
			if ($this->session->userdata('sess_logged_in')) {
			 ...
			 redirect('customer/setting/index');
