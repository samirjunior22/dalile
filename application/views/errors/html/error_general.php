...
<!-- Mirrored from mydesignhoard.com/HTML/html/service_provider/404error.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Apr 2019 23:14:26 GMT -->
<head>
	<meta charset="utf-8">
...
<body class="tg-login">
  <div id="tg-wrapper" class="tg-wrapper tg-haslayout">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<div class="tg-pagetitle">
							<h1><h1><?php echo $heading; ?></h1></h1>
						</div>
						<ol class="tg-breadcrumb">
							<li><a href="#">Home</a></li>
							<li class="tg-active"><h1> </h1></li>
						</ol>
					</div>
				</div>
			</div>
							...
							<div class="row">
								<div class="col-xs-12 col-sm-5 col-md-5 col-lg-4">
									<figure class="tg-404errorimg">
										<img src="assets/images/404-img.jpg" alt="image description">
									</figure>
								</div>
	 ...
	 <p>	<?php echo $message; ?>  </p>
										...
										<span class="tg-gobackhome">Or Go Back To <a href="/service">Main Page</a></span>
									</div>
								</div>
							</div>
						</div>
