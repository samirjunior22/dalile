    ...
    <?php echo validation_errors(); ?>
        ...
        <div class="row">
			...
			<div class="col-lg-12 col-md-12">
                      ...
                      <div class="add_listing_info" style="padding:0;">
					   ...
					   <div class="add_listing_info">
                            <h4>  Informations</h4>	
							 ...
							 <div class="row">
                            	 <div class="form-group col-sm-6">
                                   <input type="text" name="Website" id="website"  placeholder="Website (optionnel)"class="form-control">
                                </div> 
                            </div>
						  </div> 
			    ...
			    <input type="hidden" name="place_id" id="place_id" class="form-control"><br>
				<input type="hidden" name="place_types" value="<?php echo $type ?>" class="form-control"><br>
