								...
								<div class="list-box-listing-content">
									<div class="inner">
										...
										<div class="star-rating">
											<div class="rating-counter">(<?php echo $listing['totals'] ?> reviews) - <?php echo $listing['vue'] ?> Vue</div>
										</div>
									</div>
								</div>
							</div>
			...
			<div class="col-lg-12 col-md-12">
				<div class="dashboard-list-box">
					...
					<ul>
						...
						<?php if ( $resultsSer ) {?> 
						<?php foreach ( $resultsSer as $ser) {?> 
						<li>
							<div class="list-box-listing">
								<div class="list-box-listing-img"><a href="#"><img src="<?php echo base_url('assets/images/services/'.$ser['photo']); ?>" alt=""></a></div>
								<div class="list-box-listing-content">
									<div class="inner">
										<h3><a target='_blanck' href="<?=base_url('listing_detail/index/'.$ser['id']) ?>"><?php echo $ser['Title'] ?></a></h3>
										<span><?php echo $ser['Tag_Line'] ?></span>
										<div class="star-rating">
											<div class="rating-counter">(<?php echo $ser['totals'] ?> reviews) - <?php echo $ser['vue'] ?> Vue</div>
										</div>
									</div>
								</div>
							</div>
							<div class="buttons-to-right">
							 <a href="#" onclick="removeFunc(<?php echo $ser['id'] ?>)" class="button red" data-toggle="modal" data-target="#removeModal"><i class="fa fa-trash-o"></i> Delete</a>
								<a href="<?php echo base_url('customer/listing/edit/'.$ser['id']); ?>" class="button gray"><i class="fa fa-trash-o"></i> Edit</a>
							</div>
						</li>
						  <?php } ?>
						<?php } ?>
