 ...
 <div class="dashboard-content" style="min-height: 956px;">
    ...
    <section class="content">
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li id="Sent1"><a href="<?php echo base_url('/customer/messages/sentitems');?>"><i class="fa fa-envelope-o"></i> Sent
	  ...
	  <?php echo form_open('customer/messages/inbox/delete'); ?>			
            <!-- /.box-header -->
		   ...
		   <?php foreach($record as $row): ?>
                  ...
                  <tr>
                    ...
                    <td class="mailbox-name"><a href="#read_message" data-toggle="modal" class="read_message" data-id="<?php echo $row->message_id; ?>">
                           
                            <?php if($row->status=='unread') echo '  <strong>'; ?>
                            <?php echo  $row->user_from ; ?>
                            <?php if($row->status=='unread') echo ' </strong> '; ?>
                            
                          
                        </a></td>
                    <td class="mailbox-subject" ><a href="#read_message" data-toggle="modal" class="read_message" data-id="<?php echo $row->message_id; ?>">
					<?php if($row->status=='unread') echo '  <strong>'; ?>
					<?php echo ($row->subject!='') ? $row->subject:'[No Subject]'; ?></a><?php if($row->status=='unread') echo '  </strong>'; ?> </b>  
                    </td>
