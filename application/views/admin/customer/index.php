...
<div class="modal fade" tabindex="-1" role="dialog" id="editModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('admin/customer/update') ?>" method="post" id="updateForm">

        <div class="modal-body">
          <div id="messages"></div>

          <div class="form-group">
            <label for="listing__name">Date</label>
            <input type="text" class="form-control" id="date_debut" name="date_debut" disabled autocomplete="off">
          </div>
		  <div class="form-group">
            <label for="listing__name">Date</label>
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('admin/customer/remove') ?>" method="post" id="removeForm">
        <div class="modal-body">
...
$(document).ready(function() {
  ...
  $("#mainClient ").addClass('active');
  
  // initialize the datatable 
  manageTable = $('#manageTable').DataTable({
    'ajax': 'customer/fetchCustomerData',
    'order': []
  });
...
{ 
  $.ajax({
    url: 'customer/fetchCustomerDataById/'+id,
    type: 'post',
    dataType: 'json',
    success:function(response) {
