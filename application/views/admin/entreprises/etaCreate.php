      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Add Entreprises</h3>
          </div>
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('admin/Entreprises/create_ent') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="sou category">Entreprises</label>
                  <input type="text" class="form-control" id="name" name="name" placeholder="Enter nom d'entreprise" autocomplete="off" required />
                </div>
               <div class="form-group">
          ...
          <div class="form-group">
            ...
            <select class="form-control" id="active" name="active">
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url('admin/entreprises/entreprises') ?>" class="btn btn-warning">Back</a>
              </div>
            </form>
          <!-- /.box-body -->
        </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $("#creatEntreprises").addClass('active');
